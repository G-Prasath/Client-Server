    ...
    card_1: {
      ...
      para: {
        ...
        "Adjustable lifting arms":
          " Adjustable lifting arms to accommodate various vehicle sizes.",
    ...
    card_2: {
      ...
      para: {
        "Increased Parking Capacity":
          "Expands parking availability without requiring extra space.",
        "Enhanced Vehicle Protection":
          "Minimizes vehicle damage through secure and stable parking.",
        "Improved Organization":
          "Enhances the arrangement and accessibility of parked vehicles.",
        "Cost-Effective Solution":
          "Provides an economical option for residential and commercial parking needs.",
        "Property Value Enhancement":
          "Elevates property value by optimizing parking efficiency.",
      },
    },
    card_3: {
      ...
      para: {
        "Maximum lifting capacity":
          "Typically ranges from 3,000 kg (6,600 lbs) to 5,000 kg (11,000 lbs), depending on the model.",
        "Lifting height":
          "Maximum lifting height usually between 1.8 meters (71 inches) to 2 meters (79 inches).",
        "Power requirements": "220V/60Hz, single-phase.",
        "Overall dimensions": "110(height) x 135 (width).",
        "Lift Speed:":
          "Average lifting speed of about 30 to 60 seconds to full height, depending on the load.",
        Warranty:
          "Typically offers a warranty period ranging from 1 to 5 years, covering parts and labor.",
      },
    },
  },
];
...
export const FourpostData = [
  {
    title: "Four POST 1+1 Hydraulic System",
    banner: "/banner/4PostBanner.webp",
...
export const VerticalData = [
  {
    ...
    card_1: {
      ...
      para: {
        "Space Optimization":
          "Utilizes vertical space for multiple vehicles in a compact footprint.",
        "Automated Operation":
          "Completely automated system for smooth parking and retrieval of vehicles.",
        "High Capacity":
          "Capable of managing numerous parking platforms and a big number of vehicles.",
        "Safety Mechanisms":
          "Features emergency braking, safety locks, and sensors to guarantee car safety.",
        "User-Friendly Interface":
          "Natural control board for simple activity by clients and stopping attendants",
        "Low Maintenance":
          "Intended for sturdiness and negligible support prerequisites.",
      },
    },
    card_2: {
      ...
      para: {
        "Space Efficiency":
          "Boosts stopping limit without requiring broad land region.",
        "Time Savings":
          "Lessens the time expected for leaving and recovering vehicles.",
        "Enhanced Security":
          "Offers a protected climate for vehicles with durable wellbeing highlights.",
        "Cost-Effectiveness":
          "Diminished development and functional expenses than other stopping structures.",
        "Environmental Benefits":
          "Limits the natural space of parking area.",
      },
    },
    card_3: {
...
export const HorizontalData = [
  {
    ...
    card_1: {
      ...
      para: {
        ...
        "Space Optimization":
          "Utilizes horizontal space for multiple vehicles in a compact footprint.",
        "Automated Operation":
          "Fully automated system for seamless vehicle parking and retrieval.",
        "High Capacity":
          "Can handle a large number of vehicles with multiple platforms of parking.",
        "Safety Mechanisms":
          "Has sensors, safety locks, and emergency ensure vehicle safety.",
        "User-Friendly Interface":
          "Intuitive control panel for easy operation by users and parking attendants",
        "Low Maintenance":
          "Designed for durability and minimal maintenance requirements.",
    ...
    card_2: {
      ...
      para: {
        "Versatility":
          "Horizontal Rotary Parking is best to suit different design requirements.",
        "Space Efficiency":
          "Maximizes parking capacity without requiring extensive land area.",
        "Time Savings":
          "Reduces the time required for parking and retrieving vehicles.",
    ...
    card_3: {
      ...
      para: {
        "Maximum Lifting Capacity":
          "Varies based on configuration (e.g., 10-20 vehicles per system).",
        "Lifting Mechanism":
          "High-speed lift  for Vertical Rotary, rotating platform for Horizontal Rotary.",
        "Power Requirements": "380V/50Hz, three-phase.",
        "Dimensions": "Customizable based on site requirements.",
...
export const CarData = [
  {
    ...
    card_2: {
      ...
      para: {
        ...
        "Versatile Applications":
          "Suitable for various settings like garages, residences, and dealerships.",
